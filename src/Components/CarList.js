            ...
            <div class="container">
              <div class="row row-50 justify-content-start align-items-xl-center">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 text-left">
                  <h3 class="text-gray-1000">{this.state.car.name}</h3>
                  <p class="text-gray-500">
                    This project was designed for one of the biggest Swiss
                    entertainment centers that grew in popularity in 2009. One
                    of their new buildings needed top quality interior designed
                    and our studio offered the services of Will O’Brien.
